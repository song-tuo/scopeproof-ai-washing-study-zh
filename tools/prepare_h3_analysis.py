#!/usr/bin/env python3
"""Convert a v0.9 response export into preregistered H3 analysis tables."""
...
ANSWER_KEY_VERSION = "h3-set-v0.9"
ITEM_STATUS = {
    "P-S-01": "supported",
    "P-S-04": "supported",
    "A-S-01": "supported",
...
def prepare(input_path: Path, output_dir: Path, exclude_prefixes: tuple[str, ...], allow_incomplete: bool) -> None:
    ...
    if not slot_rows:
        raise ValueError("No eligible v0.9 responses remained after filtering")
